...
const JobListings: React.FC = () => {
  ...
  const fetchJobs = useCallback(async () => {
    if (typeof window === 'undefined') return; // Check jobType here
    setIsLoading(true);
  ...
  }, [selectedSources, currentPage]); // Add jobType to dependencies
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12`}>
      ...
      <h1 className="text-2xl font-bold mb-4">
        {`Remote Jobs For All Professionals`}
      </h1>

      <p className="mb-8">
            Uncover the latest remote jobs shared on LinkedIn and Twitter (X) that often fly under the radar of traditional job boards. <br />
